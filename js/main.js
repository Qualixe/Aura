...
const products = [
    ...
    { id: 8, name: "Bamboo Hooded Towel Set", price: 38.00, category: "Bath", rating: 5, image: "https://cdn.pixabay.com/photo/2016/11/19/08/00/towel-1838210_1280.jpg", featured: false, bestSeller: true, inStock: true, desc: "Ultra-absorbent bamboo terry cloth that gets softer with every wash." },
    { id: 9, name: "Artisan Rattan Bassinet", price: 250.00, category: "Nursery", rating: 5, image: "https://cdn.pixabay.com/photo/2014/12/02/15/04/baby-bassinet-554082_1280.jpg", featured: true, bestSeller: false, inStock: true, desc: "Handcrafted rattan bassinet bringing a bohemian elegance to the nursery." },
    { id: 10, name: "Organic Muslin Swaddle Set", price: 42.00, category: "Nursery", rating: 4.8, image: "https://cdn.pixabay.com/photo/2024/02/11/06/20/baby-8565993_1280.jpg", featured: false, bestSeller: true, inStock: true, desc: "Breathable, lightweight muslin cloths in earthy, muted tones." },
    ...
    { id: 12, name: "Silk Lined Booties", price: 30.00, category: "Clothing", rating: 4.9, image: "https://cdn.pixabay.com/photo/2021/08/22/15/39/kid-6565461_1280.jpg", featured: false, bestSeller: false, inStock: true, desc: "Keeps tiny toes warm with a luxurious silk lining to prevent friction." }
];
